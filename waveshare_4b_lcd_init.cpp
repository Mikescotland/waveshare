...
void Waveshare4BLcdInit::lcd_reset_sequence_() {
  ...
  // Jak w Arduino: pin 6 LOW, pin 5 LOW -> HIGH
...
void Waveshare4BLcdInit::st7701_init_() {
  ...
  {
    const uint8_t d[] = {0x08, 0xA0, 0x00, 0x00, 0x07, 0xA0, 0x00, 0x00, 0x00, 0x44, 0x44};
    this->lcd_cmd_data_(0xE1, d, sizeof(d));
  }
  {
    const uint8_t d[] = {0x11, 0x11, 0x44, 0x44, 0xED, 0xA0, 0x00, 0x00, 0xEC, 0xA0, 0x00, 0x00};
  ...
  {
    const uint8_t d[] = {0x0A, 0xE9, 0xD8, 0xA0, 0x0C, 0xEB, 0xD8, 0xA0, 0x0E, 0xED, 0xD8, 0xA0, 0x10, 0xEF, 0xD8, 0xA0};
  ...
  {
    const uint8_t d[] = {0x09, 0xE8, 0xD8, 0xA0, 0x0B, 0xEA, 0xD8, 0xA0, 0x0D, 0xEC, 0xD8, 0xA0, 0x0F, 0xEE, 0xD8, 0xA0};
  ...
  {
    const uint8_t d[] = {0xAB, 0x89, 0x76, 0x54, 0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x20, 0x45, 0x67, 0x98, 0xBA};
